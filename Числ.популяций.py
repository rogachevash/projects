...
n_rost=Label(root,text="Неограниченный рост", bg = "white",width=60,height=1); n_rost.place(x=40,y=10)
...
og_rost=Label(root, text='Ограниченный рост', bg='white', width=60,heigh=1); og_rost.place(x=40,y=70)
...
otl_rost=Label(root, text='Ограниченный рост с отловом', bg='white', width=60,heigh=1);otl_rost.place(x=40,y=130)
